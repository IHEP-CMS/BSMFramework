...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:pickevents_2233019.root', 
...
process.p = cms.Path(process.selectedHadronsAndPartons+process.genJetFlavourInfos+process.matchGenCHadron+process.matchGenBHadron+process.egmGsfElectronIDSequence+process.TNT)
