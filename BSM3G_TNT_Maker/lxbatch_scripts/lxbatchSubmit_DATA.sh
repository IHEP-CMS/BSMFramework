...
#====== cmsRun Config File =======
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunBCD_DL.py
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunBCD_SL.py
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunEF_DL.py
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunEF_SL.py
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunG_DL.py
cmsRun $CMSSW_SRC/$PROJECTDIR/python/miniAOD_RunG_SL.py
