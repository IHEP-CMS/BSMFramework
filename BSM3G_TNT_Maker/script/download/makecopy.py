...
workpath = "/publicfs/cms/user/joshuha/scripts"

#Create the CopyFiles
##MC##
CopyScriptMCName = "copymc.sh"
CopyScriptMC      = file(CopyScriptMCName,"w")
print >> CopyScriptMC, "for ((i=1;i<560;i++))"
print >> CopyScriptMC, "do"
DelScriptMCName = "delmc.sh"
DelScriptMC      = file(DelScriptMCName,"w")
print >> DelScriptMC, "for ((i=1;i<560;i++))"
print >> DelScriptMC, "do"
##data##
CopyScriptDataName = "copydata.sh"
CopyScriptData      = file(CopyScriptDataName,"w")
print >> CopyScriptData, "for ((i=1;i<82;i++))"
print >> CopyScriptData, "do"
DelScriptDataName = "deldata.sh"
DelScriptData      = file(DelScriptDataName,"w")
print >> DelScriptData, "for ((i=1;i<82;i++))"
print >> DelScriptData, "do"

#For Tier 2 Data
#PathT2 = '/pnfs/ihep.ac.cn/data/cms/store/user/fromeo'
#PathT2 = '/pnfs/ihep.ac.cn/data/cms/store/user/binghuan'
PathT2 = '/pnfs/ihep.ac.cn/data/cms/store/user/jthomasw/TTHbb/BSMFramework/output_4'

#For Tier 3 Directory
mclocaldir = "/publicfs/cms/data/TopQuark/ttHbb/JTW/crab_Moriond17/mc"
datalocaldir = "/publicfs/cms/data/TopQuark/ttHbb/JTW/crab_Moriond17/data"
...
'ttHTobb_M125_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8/TTHbb_MC_ttHbb_4/170621_142513/0000/',
'TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/TTHbb_MC_ttjets_4/170621_142726/0000/'
...
## Data##
'SingleElectron/crab_TTHbb_SEleBlockB1/170621_143500/0000/', #'FullMorV1_SEleBlockB1', 1758
'SingleElectron/crab_TTHbb_SEleBlockB1/170621_143500/0001/', #'FullMorV1_SEleBlockB1', 1758
'SingleElectron/crab_TTHbb_SEleBlockC1/170621_143729/0000/', #'FullMorV1_SEleBlockC1', 580
'SingleElectron/crab_TTHbb_SEleBlockD1/170621_143954/0000/', #'FullMorV1_SEleBlockD1', 972
'SingleElectron/crab_TTHbb_SEleBlockE1/170621_144216/0000/', #'FullMorV1_SEleBlockE1', 826
'SingleElectron/crab_TTHbb_SEleBlockF1/170621_144427/0000/', #'FullMorV1_SEleBlockF1', 523
'SingleElectron/crab_TTHbb_SEleBlockF2/170621_144635/0000/', #'FullMorV1_SEleBlockF2', 81
'SingleElectron/crab_TTHbb_SEleBlockG1/170621_144846/0000/', #'FullMorV1_SEleBlockG1', 1423
'SingleElectron/crab_TTHbb_SEleBlockG1/170621_144846/0001/', #'FullMorV1_SEleBlockG1', 1423
'SingleElectron/crab_TTHbb_SEleBlockH1/170621_145056/0000/', #'FullMorV1_SEleBlockH1', 1541
'SingleElectron/crab_TTHbb_SEleBlockH1/170621_145056/0001/', #'FullMorV1_SEleBlockH1', 1541
'SingleElectron/crab_TTHbb_SEleBlockH2/170626_141046/0000/',#'FullMorV1_SEleBlockH2', 41
'SingleMuon/crab_TTHbb_SMuBlockB1/170621_145517/0000/', #'FullMorV1_SMuBlockB1',  1756
'SingleMuon/crab_TTHbb_SMuBlockB1/170621_145517/0001/', #'FullMorV1_SMuBlockB1',  1756
'SingleMuon/crab_TTHbb_SMuBlockC1/170621_145733/0000/', #'FullMorV1_SMuBlockC1',  580
'SingleMuon/crab_TTHbb_SMuBlockD1/170621_145947/0000/', #'FullMorV1_SMuBlockD1',  972
'SingleMuon/crab_TTHbb_SMuBlockE1/170621_150159/0000/', #'FullMorV1_SMuBlockE1',  826
'SingleMuon/crab_TTHbb_SMuBlockF1/170621_150407/0000/', #'FullMorV1_SMuBlockF1',  523
'SingleMuon/crab_TTHbb_SMuBlockF2/170621_150618/0000/', #'FullMorV1_SMuBlockF2',  81
'SingleMuon/crab_TTHbb_SMuBlockG1/170621_150829/0000/', #'FullMorV1_SMuBlockG1',  1423
'SingleMuon/crab_TTHbb_SMuBlockG1/170621_150829/0001/', #'FullMorV1_SMuBlockG1',  1423
'SingleMuon/crab_TTHbb_SMuBlockH1/170621_151043/0000/', #'FullMorV1_SMuBlockH1',  1541
'SingleMuon/crab_TTHbb_SMuBlockH1/170621_151043/0001/', #'FullMorV1_SMuBlockH1',  1541
'SingleMuon/crab_TTHbb_SMuBlockH2/170621_151255/0000/' #'FullMorV1_SMuBlockH2',  41 
]

for mcchannel in mcchannels:

        mclocalFiledir = mclocaldir + "/"+mcchannel
        if not os.path.isdir(mclocalFiledir):
                  os.popen('mkdir -p '+mclocalFiledir)
        print >> CopyScriptMC, "srmcp -debug srm://srm.ihep.ac.cn" + PathT2 + "/" + mcchannel + "/OutTree_${i}.root " + "file:///" + mclocalFiledir
        print >> DelScriptMC, "srmrm -debug srm://srm.ihep.ac.cn" + PathT2 + "/" + mcchannel + "/OutTree_${i}.root "

for datachannel in datachannels:

        datalocalFiledir = datalocaldir + "/"+datachannel
        if not os.path.isdir(datalocalFiledir):
                  os.popen('mkdir -p '+datalocalFiledir)
        print >> CopyScriptData, "srmcp -debug srm://srm.ihep.ac.cn" + PathT2 + "/" + datachannel + "/OutTree_${i}.root " + "file:///" + datalocalFiledir
        print >> DelScriptData, "srmcp -debug srm://srm.ihep.ac.cn" + PathT2 + "/" + datachannel + "/OutTree_${i}.root "




print >> CopyScriptMC, "done"
print >> CopyScriptData, "done"
print >> DelScriptMC, "done"
print >> DelScriptData, "done"

os.popen('chmod +x '+CopyScriptMCName)
os.popen('chmod +x '+CopyScriptDataName)
os.popen('chmod +x '+DelScriptMCName)
os.popen('chmod +x '+DelScriptDataName)
